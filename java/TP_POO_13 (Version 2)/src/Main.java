...
public class Main {
	...
	public static void combatPokemon(Pokemon pok1,Pokemon pok2) {
		...
		String class1 = pok1.getClass().getName();
		String class2 = pok2.getClass().getName();
		while (!pok1.isDead() && !pok2.isDead()) {
			if (class2 =="PokemonFeu" ){
				pok1.attaquer( (PokemonFeu) pok2);
			}else if (class2 =="PokemonEau" ){
				pok1.attaquer( (PokemonEau) pok2);
			}else if (class2 == "PokemonPlante"){
				pok1.attaquer( (PokemonPlante) pok2);
			}else {
				pok1.attaquer( (PokemonNormal) pok2);
			}
			...
			if (class1 =="PokemonFeu" ){
				pok2.attaquer( (PokemonFeu) pok1);
			}else if (class1 =="PokemonEau" ){
				pok2.attaquer( (PokemonEau) pok1);
			}else if (class1 == "PokemonPlante"){
				pok2.attaquer( (PokemonPlante) pok1);
			}else {
				pok2.attaquer( (PokemonNormal) pok1);
			}
